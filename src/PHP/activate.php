...
<body>
<h2>Stimulsoft Reports.PHP - How to activate the Product</h2>
<hr/>
<br/>
...
<ul>
    <li>Set the key as a Base64 string for the StiHandler() object:<br/>
        <code>$handler = new \Stimulsoft\StiHandler();<br/>$handler->license->setKey('6vJhGtLLLz2GNviWmUTrhSqnO...');</code><br/><br/></li>
    <li>Set the key as a license file for the StiHandler() object:<br/>
        <code>$handler = new \Stimulsoft\StiHandler();<br/>$handler->license->setFile('license.key');</code><br/><br/></li>
